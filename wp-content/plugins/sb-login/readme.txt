...
Tags: sb login, sb, login, sidebar login widget, user login widget, user registration, custom login widget, login widget, science breeze, fida al hasan, widget, register, cool, bangla, recent activity, web care zone, webcarezone
...
*     Bengali 
*     Persian by <a href="http://www.alimir.ir">Ali Mirzaei</a>
*     French by darth
*     Italian by [Redazione](http://www.iononmollo.it) 
...
* 1.3 - jQuery blockUI plugin version upgraded to 2.64.0

* 1.2 - Italian translation added, added plural translation in translated files
